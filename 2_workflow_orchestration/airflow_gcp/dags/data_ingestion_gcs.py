...
path_to_local_home = os.environ.get("AIRFLOW_HOME", "/opt/a your Airflow DAG code, you can set up Google Cloud authentirflow/")
...
logger.info(f'{BUCKET} is the bucket, {PROJECT_ID} is the project id, {BIGQUERY_DATASET} is the bigquery dataset.')
